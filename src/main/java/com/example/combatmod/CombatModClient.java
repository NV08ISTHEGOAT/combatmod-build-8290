...
public class CombatModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        PlaceholderAPI.register(Identifier.of(MOD_ID, "reach"), (ctx, arg) -> PlaceholderResult.value(ModConfig.reachEnabled ? "Enabled" : "Disabled"));
        PlaceholderAPI.register(Identifier.of(MOD_ID, "reveal"), (ctx, arg) -> PlaceholderResult.value(ModConfig.invisRevealEnabled ? "Enabled" : "Disabled"));
        PlaceholderAPI.register(Identifier.of(MOD_ID, "reach_distance"), (ctx, arg) -> PlaceholderResult.value(String.format("%.1f", ModConfig.reachDistance)));
